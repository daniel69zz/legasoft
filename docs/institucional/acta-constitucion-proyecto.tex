%% Acta de constitución del proyecto (plantilla)
%% Compilar: tectonic -X compile acta-constitucion.tex
...
\lgtituloCorto{Acta de constitución}
\lgcodigo{LGS-INST-002}
\lgversion{0.1}
\lgestado{Plantilla — pendiente de completar}
...
El documento de constitución de Legasoft (\texttt{LGS-INST-001}) reconoce el acta
de constitución como un entregable pendiente. Esta plantilla fija su estructura;
los campos marcados en ámbar deben sustituirse por los datos reales una vez
seleccionada la organización cliente. Al completarla, cambie el estado a
\emph{Aprobado} y suba la versión a 1.0.
\end{porcompletar}
