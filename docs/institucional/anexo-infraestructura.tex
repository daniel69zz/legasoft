...
Las plantillas marcan en ámbar sus campos variables (\campo{así}), para que
ninguna plantilla pueda confundirse con un documento aprobado.
...
Las tecnologías de frontend, backend y pruebas de las carpetas \ruta{src/} y
\ruta{tests/} se registran como decisiones de arquitectura (ADR) en
\ruta{docs/arquitectura/adr/}, de acuerdo con el principio de intervención de la
consultora, según el cual cada proyecto debe justificar la tecnología que
incorpora.
\end{nota}
