...
Esta primera versión delimita los fundamentos institucionales, las líneas de
servicio, los objetivos, los referentes normativos y la estructura del equipo. La
infraestructura de trabajo, el acta de constitución, la estructura detallada del
repositorio y la documentación técnica asociada se incorporarán en una versión
posterior; por tanto, no se presentan aquí como elementos concluidos.
...
El nombre \emph{Legasoft} integra dos conceptos que sintetizan la forma de
trabajo de la consultora. \emph{Lega}, de la raíz latina \emph{legare}
—legar, transmitir—, alude a lo que una solución deja instalado en la
organización una vez terminado el proyecto: procesos ordenados, decisiones
documentadas y capacidad de mantenimiento. \emph{Soft}, abreviación de
\emph{software}, sitúa esa transmisión en el terreno de la construcción técnica
disciplinada.

Esta combinación comunica una identidad centrada tanto en la comprensión del
problema como en la durabilidad de la respuesta. Legasoft no concibe la
tecnología como un fin aislado, sino como un medio para mejorar procesos, apoyar
decisiones y generar capacidades sostenibles en las organizaciones con las que
colabora. Un sistema que nadie puede mantener después de la entrega no se
...
Las hojas de vida completas de los integrantes se encuentran disponibles en los
siguientes enlaces:
...
Legasoft dispone de una organización en GitHub como punto institucional para la
colaboración y la gestión futura de activos de software.

\begin{porcompletar}[Enlace pendiente]
Registrar aquí la dirección de la organización \emph{Legasoft Consulting} en
GitHub: \campo{URL de la organización}.
\end{porcompletar}

La dirección anterior corresponde a la organización de GitHub de Legasoft; no
identifica un repositorio específico del proyecto ni implica que la
infraestructura técnica ya se encuentre creada. El enlace al repositorio que
alojará la documentación técnica se incorporará cuando se complete la
...
innovación proporcional y responsable. Para completar su base operativa será
necesario incorporar posteriormente la infraestructura de trabajo, el repositorio
técnico específico y el acta de constitución inicial, además de resolver los
datos personales e institucionales pendientes. Estos elementos se reconocen como
próximos entregables y no se presentan como finalizados en esta versión.
